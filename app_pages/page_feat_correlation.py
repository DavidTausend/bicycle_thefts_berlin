...
def page_feat_correlation_body():
    ...
    st.write("""
    We need to perform a correlation study to determine which features correlate most closely with bicycle theft occurrences.
    This will help identify key attributes that impact theft risk and can be used to improve prediction models.
    """)
    ...
    if numeric_data.empty:
        st.error("No numeric columns found in the dataset to calculate correlation.")
        return
    ...
    st.write("""
    The Pearson correlation matrix provides insights into relationships between various numerical attributes in the dataset.
    This information can guide feature selection for model development.
    """)
